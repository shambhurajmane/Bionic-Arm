...
analogWrite(thumb,250); //thumb cha varcha
//
//analogWrite(index_u,250); //index varcha
//
//analogWrite(index,250); // index khalcha
//
analogWrite(middle,250); // middle khalcha
//

//

    digitalWrite(in1, LOW);///UP //1
    digitalWrite(in2, HIGH);///UP //1
    //digitalWrite(in1, HIGH);///DOWN
    //digitalWrite(in2, LOW);///DOWN
    analogWrite(ring,250); // ring cha khalcha
    //
    digitalWrite(in3, LOW);//UP //1
    digitalWrite(in4, HIGH);//UP //1
    //digitalWrite(in3, HIGH);//DOWN //
    //digitalWrite(in4, LOW);//DOWN
    //analogWrite(little, 250);  // little cha khalcha





thumb2.writeMicroseconds(180);
middle2.writeMicroseconds(1800);
ring2.writeMicroseconds(1800);
little2.writeMicroseconds(1800000000000);
